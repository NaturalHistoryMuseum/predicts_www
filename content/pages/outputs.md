...
<div style="padding: 0px 30px">
  ...
  <div>
    ...
    <div id="lk_2012" style="display: none">
      ...
      has increased to several orders of magnitude higher than sustainable
...
<p>
  Sam Hill's
  <!-- <a href="./outputs/SHPosterBESYESI2013.pdf"> -->
  poster presented at the
...
<ul>
  <li>Andy Purvis' talk <!-- <a href="./outputs/APTalkBES2012.pdf"> -->
    Towards a global
    model of local biodiversity responses to human impacts</li>
<!--          <li>Tim Newbold's talk <a href="./outputs/TNTalkBES2012.pdf">
      Taxonomic and functional patterns in the response of tropical
      forest species to land-use change</a></li>-->
  <li>Adriana De Palma's poster <!-- <a href="./outputs/ADPPosterBES2012.pdf"> -->
    Modelling the responses of pollinators to anthropogenic threats in
    agricultural landscapes</a></li>
  <li>Helen Phillips' poster <!-- <a href="./outputs/HPPosterBES2012.pdf"> -->
    Responses of biodiversity to land-use change: Is the biota of Asia
    more sensitive than other continents?</a></li>
  <li>Our <!-- <a href="./outputs/PREDICTSFlyerBES2012.pdf"> -->
    flyer requesting data</li>
</ul>
<p>
  We presented a <!-- <a href="./outputs/PREDICTSPoster2012-06-11.pdf"> -->
