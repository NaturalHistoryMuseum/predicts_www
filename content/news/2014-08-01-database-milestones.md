...
![Photo of Susan Emerson]({filename}/images/photos/susan500.jpg){class="photo photoright"}

The PREDICTS database has topped 500 studies and 2 million records this week.
[Susan Emerson]({filename}/pages/team.md#SE) uploaded the 500<sup>th</sup> study, from
...
[Katia Sanchez Ortiz]({filename}/pages/team.md#KSO) uploaded
...
The [outputs]({filename}/pages/outputs.md) page has a map of sampling
